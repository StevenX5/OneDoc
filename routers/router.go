...
func init() {
	...
	// 关于我们
	web.Router("/about/license", &controllers.AboutController{}, "*:License")
	web.Router("/about/support", &controllers.AboutController{}, "*:Support")
	web.Router("/about/about", &controllers.AboutController{}, "*:About")
	web.Router("/about/contact", &controllers.AboutController{}, "*:Contact")
}
