...
<head>
    ...
    <title>{{i18n .Lang "common.contact"}} - {{.SITE_NAME}}</title>
							...
							<div class="blog__sidebar mb-30">
								<div class="sidebar__widget mb-30">
									<div class="sidebar__widget-title">
										 <h3>{{i18n .Lang "common.contact"}}</h3>
									</div>
									<div class="sidebar__widget-content">
										 <div class="sidebar__catagory">
												<ul>
													 ...
													 <li><a href="{{urlfor "AboutController.Contact"}}"><span style="color:#5f3afc">{{i18n .Lang "common.contact"}}</span></a></li>
												</ul>
										 </div>
									</div>
								</div>
					...
					<div class="col-xxl-9 col-xl-9 col-lg-9 pl-50">
						 <div class="postbox__wrapper">
								<div class="postbox__details text-center mb-30">
									 <h4>{{i18n .Lang "common.contact"}}</h4>
								</div>
								<div class="postbox__details mb-30">
									 <p>如果您在使用中遇到任何问题，请通过以下方式联系我们。</p>
									 <p>邮箱：<span class="highlight">1029993198#qq.com</span>&nbsp;&nbsp;(请用 @ 替代 #)</p>
									 <p>我们在收到邮件后会尽快回复您。</p>
									 <p></p>
								</div>
						 </div>
