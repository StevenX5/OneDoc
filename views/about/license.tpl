...
<head>
    ...
    <title>{{i18n .Lang "common.license"}} - {{.SITE_NAME}}</title>
							...
							<div class="blog__sidebar mb-30">
								<div class="sidebar__widget mb-30">
									<div class="sidebar__widget-title">
										 <h3>{{i18n .Lang "common.license"}}</h3>
									</div>
									<div class="sidebar__widget-content">
										 <div class="sidebar__catagory">
												<ul>
													 <li><a href="{{urlfor "AboutController.License"}}"><span style="color:#5f3afc">{{i18n .Lang "common.license"}}</span></a></li>
					...
					<div class="col-xxl-9 col-xl-9 col-lg-9 pl-50">
						 <div class="postbox__wrapper">
								<div class="postbox__details text-center mb-30">
									 <h4>{{i18n .Lang "common.license"}}</h4>
								</div>
								<div class="postbox__details mb-30">
									 <p>本站所有文章和教程，遵循 <span class="highlight"><a href="https://www.apache.org/licenses/LICENSE-2.0" target="_blank">Apache License Version 2.0</a></span> 版权协议，转载请附上原文出处链接。</p>
								</div>
						 </div>
					</div>
			 </div>
